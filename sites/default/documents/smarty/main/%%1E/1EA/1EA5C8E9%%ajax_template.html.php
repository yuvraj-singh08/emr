<?php /* Smarty version 2.6.33, created on 2024-10-15 14:33:34
         compiled from default/views/day/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 11, false),array('function', 'xla', 'default/views/day/ajax_template.html', 166, false),array('function', 'xlt', 'default/views/day/ajax_template.html', 166, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 377, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 372, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 373, false),)), $this); ?>
...
echo "   <a href='#' type='button' id='createMeet' title='" . xla('Month View') . "' class='btn btn-primary'>" . xlt('Create Meet') . "</a>\n";
 ?>
</div>
...
<script>
    ...
    const createZoom = document.getElementById("createMeet");
    createZoom.addEventListener("click", async () => {
       try {
           console.log("Called");
           parent.navigateTab('/openemr/interface/zoom/index.html', 'meet', () => {});
       } catch (error) {
           console.log("Error creating meet: ", error.message);
       }
    });
});
